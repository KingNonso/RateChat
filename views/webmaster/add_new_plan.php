...
?>
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
        <h1>
           Add <?php echo ($this->manager['surname'].' '.$this->manager['firstname']); ?> as Manager to Hostel
...
<?php }else{?>
        <div class="box box-primary">
            ...
            <h3 class="box-title">Add New Plans </h3>
            </div>
        </div>
<?php }?>
                ...
                <div class="list-group">
                    <?php if(isset($this->hostel)){
                        foreach($this->hostel as $h){ ?>
                            ...
                            <a href="<?php echo(URL.'webmaster/set_hostel_manager/'.$this->manager['id'].'/'.$h['hostel_id']); ?>" class="list-group-item">
