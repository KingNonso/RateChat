...
s_a[169]="Abuja Federal Capital Territory|Abia|Adamawa|Akwa Ibom|Anambra|Bauchi|Bayelsa|Benue|Borno|Cross River|Delta|Ebonyi|Edo|Ekiti|Enugu|Gombe|Imo|Jigawa|Kaduna|Kano|Katsina|Kebbi|Kogi|Kwara|Lagos|Nassarawa|Niger|Ogun|Ondo|Osun|Oyo|Plateau|Rivers|Sokoto|Taraba|Yobe|Zamfara";
s_a[170]="Niue";
...
var lga = new Array();
//List of Local Govt Areas in Nigeria
lga[0] = "";
lga[1] = "Abaji|Bwari|Gwagwalada|Kuje|Kwali|Abuja Municipal Area Council";
lga[2] = "Aba North|Aba South|Arochukwu|Bende|Ikwuano|Isiala Ngwa North|Isiala Ngwa South|Isuikwuato|Obi Ngwa|Ohafia|Osisioma|Ugwunagbo|Ukwa East|Ukwa West|Umuahia North|muahia South|Umu Nneochi";
...
lga[7] = "Brass|Ekeremor|Kolokuma Opokuma|Nembe|Ogbia|Sagbama|Southern Ijaw|Yenagoa";
lga[8] = "Agatu|Apa|Ado|Buruku|Gboko|Guma|Gwer East|Gwer West|Katsina-Ala|Konshisha|Kwande|Logo|Makurdi|Obi|Ogbadibo|Ohimini|Oju|Okpokwu|Oturkpo|Tarka|Ukum|Ushongo|Vandeikya";
...
lga[19] = "Birnin Gwari|Chikun|Giwa|Igabi|Ikara|Jaba|Jema a|Kachia|Kaduna North|Kaduna South|Kagarko|Kajuru|Kaura|Kauru|Kubau|Kudan|Lere|Makarfi|Sabon Gari|Sanga|Soba|Zangon Kataf|Zaria";
...
lga[33] = "Abua Odual|Ahoada East|Ahoada West|Akuku-Toru|Andoni|Asari-Toru|Bonny|Degema|Eleme|Emuoha|Etche|Gokana|Ikwerre|Khana|Obio Akpor|Ogba Egbema Ndoni|Ogu Bolo|Okrika|Omuma|Opobo Nkoro|Oyigbo|Port Harcourt|Tai";
...
function populateLGA( stateElementId, lgaElementId ){
    ...
    lgaElement.length=0;	// rebranded by King
...
function populateStates( countryElementId, stateElementId,lgaElementId ){
    ...
    if( lgaElementId){
        //show LGA ELEMENT
        //var lga = document.getElementById( lgaElementId );
        var lga = document.getElementById("lga_holder");

        if(selectedCountryIndex===169){ //if it is Nigeria
            lga.innerHTML = '<select class="form-control" id="lga" name="lga"></select>';

            stateElement.onchange = function(){
                populateLGA( stateElementId, lgaElementId );
            };
        }else{
            if(selectedCountryIndex !=169){ //if it is not Nigeria
                lga.innerHTML = '<input type="text"  class="form-control" name="lga" id="lga" />';
            }
        }
...
function populateCountries(countryElementId, stateElementId, lgaElementId){
    ...
    if( stateElementId ){
        countryElement.onchange = function(){
            populateStates( countryElementId, stateElementId, lgaElementId );
        };
    }
}